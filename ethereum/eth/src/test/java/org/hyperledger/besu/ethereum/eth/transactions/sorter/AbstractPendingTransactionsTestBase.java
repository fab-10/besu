...
public abstract class AbstractPendingTransactionsTestBase {
    ...
    final AbstractPendingTransactionsSorter evictSingleTransactions =
        getSorter(
            ImmutableTransactionPoolConfiguration.builder()
                ...
                .build(),
            Optional.of(clock));
    evictSingleTransactions.addRemoteTransaction(transaction0, Optional.empty());
  ...
  public void shouldEvictExclusivelyOldTransactions() {
    ...
    twoHourEvictionTransactionPool.addRemoteTransaction(transaction0, Optional.empty());
