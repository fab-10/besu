...
public class PendingTransactionEstimatedMemorySizeTest extends BaseTransactionPoolTest {
  ...
  /**
   * Field that points to constant values, across all pending transaction types, and are ignored during the calculation
   */
  private static final Set<String> COMMON_CONSTANT_FIELD_PATHS =
      Set.of(".value.ctor", ".hashNoSignature", ".signature.encoded.delegate");
  /**
   * Field that points to constant values, for EIP-1559 and EIP-4844 pending transactions, and are ignored during the calculation
   */
  ...
  /**
   * Field that points to constant values, for Frontier and Access List pending transactions, and are ignored during the calculation
   */
