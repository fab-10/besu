...
import static org.hyperledger.besu.ethereum.eth.sync.Utils.blocksToSyncBlocks;
import static org.hyperledger.besu.ethereum.eth.sync.Utils.receiptsToSyncReceipts;
...
public class ImportSyncBlocksStepTest {
  ...
  public void shouldImportBlocks() {
    ...
    blocksWithReceipts.forEach(
        blockWithReceipts ->
            verify(blockchain).unsafeImportSyncBodyAndReceipts(blockWithReceipts, false, Optional.empty()));
