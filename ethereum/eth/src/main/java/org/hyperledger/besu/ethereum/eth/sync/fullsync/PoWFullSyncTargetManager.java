...
class PoWFullSyncTargetManager extends AbstractFullSyncTargetManager {

  private static final Logger LOG = LoggerFactory.getLogger(PoWFullSyncTargetManager.class);

  PoWFullSyncTargetManager(
