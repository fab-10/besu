...
class AbstractFullSyncTargetManager extends SyncTargetManager {

  private static final Logger LOG = LoggerFactory.getLogger(AbstractFullSyncTargetManager.class);
  protected final SyncTerminationCondition terminationCondition;

  AbstractFullSyncTargetManager(
