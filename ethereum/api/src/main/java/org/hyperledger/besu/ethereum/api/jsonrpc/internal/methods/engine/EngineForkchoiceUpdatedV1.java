...
public sealed class EngineForkchoiceUpdatedV1<
  ...
  public JsonRpcResponse syncResponse(final JsonRpcRequestContext requestContext) {
    ...
    applyRequestParameters(requestParameters);
   ...
   * after a successful {@link #readRequestParameters(JsonRpcRequestContext)} and before any FCU
   * processing. Default: no-op. See {@link EngineForkchoiceUpdatedV4} for the {@code
   * custodyColumns} override.
   */
