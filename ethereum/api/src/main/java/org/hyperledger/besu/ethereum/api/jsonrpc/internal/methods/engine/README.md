...
an optional field, so V1 and V2 coexist permanently, with no fork window on either
(`startsFromBeginningUntil(EngineGetPayloadBodiesByHashV1::new, null).thenAlsoFromBeginning(EngineGetPayloadBodiesByHashV2::new)`).
