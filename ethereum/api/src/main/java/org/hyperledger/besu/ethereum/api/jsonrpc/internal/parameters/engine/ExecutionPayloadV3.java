...
/**
 * Engine API {@code ExecutionPayloadV3} — Cancun (Blobs).
 *
 * <p>Extends V2 with the blob-related fields {@code blobGasUsed} and {@code excessBlobGas}.
 */
public sealed class ExecutionPayloadV3 extends ExecutionPayloadV2 permits ExecutionPayloadV4 {
  ...
  /**
   * Creates an instance of {@code ExecutionPayloadV3}.
   *
  ...
  /**
   * Returns the blob gas used by the block, or {@code null} when omitted.
   *
  ...
  /**
   * Returns the hex-encoded excess blob gas value, or {@code null} when omitted.
   *
   * @return the excess blob gas, hex-encoded
   */
