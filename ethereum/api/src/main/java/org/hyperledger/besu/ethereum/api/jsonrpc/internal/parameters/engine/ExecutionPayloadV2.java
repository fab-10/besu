...
/**
 * Engine API {@code ExecutionPayloadV2} — Shanghai (Withdrawals).
 *
 * <p>Extends V1 with the {@code withdrawals} field.
 */
public sealed class ExecutionPayloadV2 extends ExecutionPayloadV1 permits ExecutionPayloadV3 {
  ...
  /**
   * Creates an instance of {@code ExecutionPayloadV2}.
   *
   ...
   * @param withdrawals Array of {@link WithdrawalParameter}, or {@code null}
   */
  @JsonCreator
  ...
  /**
   * Returns the withdrawals list, or {@code null} when omitted.
   *
