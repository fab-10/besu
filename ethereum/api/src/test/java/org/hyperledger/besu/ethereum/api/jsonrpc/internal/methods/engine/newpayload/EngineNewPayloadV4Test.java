...
public class EngineNewPayloadV4Test extends EngineNewPayloadV3Test {
  ...
  protected EngineNewPayloadV1<?> createMethodInstance() {
    return new EngineNewPayloadV4<ExecutionPayloadV3>(
        vertx,
        protocolSchedule,
        protocolContext,
        mergeCoordinator,
  ...
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAtOrAfterAmsterdamMilestone() {
    // V4's constructor caches the AMSTERDAM milestone. Use the configured value rather than
    // re-stubbing milestoneFor(AMSTERDAM) at test time.
