...
public abstract class AbstractBlockTransactionSelectorTest {
  ...
  protected BlockTransactionSelectionService blockTransactionSelectionService;
  ...
  public void setup() {
    ...
    blockTransactionSelectionService = new BlockTransactionSelectionServiceImpl();
  ...
  public void transactionSelectionPluginShouldWork_PreProcessing() {
    ...
    final BlockTransactionSelectorFactory transactionSelectorFactory =
        () ->
    ...
    blockTransactionSelectionService.registerPluginTransactionSelectorFactory(
    ...
    final TransactionSelectionResults transactionSelectionResults =
        selector.selectTransactionsForBlock();
  ...
  public void transactionSelectionPluginShouldBeNotifiedWhenTransactionSelectionCompletes() {
    final BlockTransactionSelectorFactory transactionSelectorFactory =
        mock(BlockTransactionSelectorFactory.class);
    TransactionSelector transactionSelector = mock(TransactionSelector.class);
  ...
  public void decreaseOfMinGasPriceAtRuntimeIncludeTxThatWasPreviouslyNotSelected() {
    ...
    final BlockTransactionsSelector selector1 =
        createBlockSelectorAndSetupTxPool(
            miningConfiguration,
            transactionProcessor,
            blockHeader,
    ...
    final TransactionSelectionResults results1 = selector1.selectTransactionsForBlock();
    ...
    final BlockTransactionsSelector selector2 =
        createBlockSelector(
            miningConfiguration,
            transactionProcessor,
            blockHeader,
    ...
    final TransactionSelectionResults results2 = selector2.selectTransactionsForBlock();
  ...
  protected BlockTransactionsSelector createBlockSelectorAndSetupTxPool(
      final MiningConfiguration miningConfiguration,
  ...
  protected BlockTransactionsSelector createBlockSelector(
      final MiningConfiguration miningConfiguration,
      final MainnetTransactionProcessor transactionProcessor,
      final ProcessableBlockHeader blockHeader,
      final Address miningBeneficiary,
    ...
    final BlockTransactionsSelector selector =
        new BlockTransactionsSelector(
            ...
            blockTransactionSelectionService.createPluginTransactionSelector(),
            ethScheduler);
