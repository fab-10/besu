...
public class SelectorState<T> {
   ...
   */
  public SelectorState(final T initialState) {
   ...
   * value remains pending, meaning it could be discarded, until {@link SelectorState#confirm(Hash)}
